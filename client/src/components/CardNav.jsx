...
const CardNav = ({
  ...
  return (
    <div className={`card-nav-container absolute w-full ${className}`}>
      <nav
        ref={navRef}
        className={`card-nav ${
          isExpanded ? "open" : ""
      ...
      >
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] ">
          <div
